...
import com.trustdecision.tdocrdoccapture.utils.ScreenUtils;

import java.util.List;

public class TDCameraPreview extends SurfaceView implements SurfaceHolder.Callback {

    private static String TAG = TDCameraPreview.class.getName();
    ...
    public TDCameraPreview(Context context) {
        super(context);
        init(context);
    }

    public TDCameraPreview(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public TDCameraPreview(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public TDCameraPreview(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
     ...
     * @param w     SurfaceView width
     * @param h     SurfaceView height
     * @return
     */
    ...
    /**
     * Focus, touch focus or auto focus in CameraActivity
     */
    public void focus() {
        if (camera != null) {
            try {
     ...
     * takePhoto
     *
     * @param pictureCallback Processing photo callback in pictureCallback
     */
